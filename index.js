...
class allyinvestApi {
  ...
  _buildFxml(body) {
    const options = { declaration: { include: false, encoding: 'UTF-8' }};
    const fixmlRoot = {
      '@': {
  ...
  getTimeSalesForSymbols({ symbols = 'AAPL', startdate = '2020-04-06', enddate = '2020-05-06', interval = '1min' }) {
    return this._getApiEndPoint(`market/timesales`, `symbols=${symbols}&startdate=${startdate}&enddate=${enddate}&interval=${interval}`);
  }
